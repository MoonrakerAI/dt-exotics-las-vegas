...
export default function FloatingChat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Chat Window */}
      <div
        className={`absolute bottom-24 right-0 w-96 h-[500px] bg-dark-metal border-2 border-gray-600/30 rounded-2xl shadow-2xl transform transition-all duration-500 ease-in-out ${
          isOpen 
