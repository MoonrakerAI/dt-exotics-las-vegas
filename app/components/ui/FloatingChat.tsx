...
export default function FloatingChat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Chat Window */}
      <div
        className={`absolute bottom-28 right-0 w-96 h-[560px] bg-dark-metal border-2 border-gray-600/30 rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 ease-in-out ${
          isOpen 
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-gray-600/30 bg-dark-metal rounded-t-2xl">
        ...
        {/* Messages */}
        <div className="flex-1 p-4 h-[400px] overflow-y-auto custom-scrollbar bg-dark-metal">
        ...
        {/* Input */}
        <div className="p-4 border-t border-gray-600/30 bg-dark-metal rounded-b-2xl">
